...
#include "genesis/concreteMainNetwork.cpp"
...
#include "genesis/test/concreteTestNetwork.cpp"
...
std::string const& dev::eth::genesisInfo(Network _n)
{
    ...
    {
    //Client genesis
    case Network::concreteMainNetwork: return c_genesisInfoConcreteMainNetwork;
    case Network::MainNetwork: return c_genesisInfoMainNetwork;
    case Network::Ropsten: return c_genesisInfoRopsten;

    //Test genesis
    case Network::concreteTestNetwork: return c_genesisInfoConcreteTestNetwork;
...
h256 const& dev::eth::genesisStateRoot(Network _n)
{
    switch (_n)
    {
    case Network::concreteMainNetwork: return c_genesisStateRootConcreteMainNetwork;
    case Network::concreteTestNetwork: return c_genesisStateRootConcreteTestNetwork;
