...
////////////////////////////////////////////////////////////// // concrete
	void setConcreteSchedule(EVMSchedule _concreteSchedule) const { concreteSchedule = _concreteSchedule; }

	EVMSchedule& getConcreteSchedule() const { return concreteSchedule; }
...
private:
	...
	mutable EVMSchedule concreteSchedule; // concrete
